...
from gestionvencimientos.views import amrtr, busqueda_vencidos, acrev, calculo_next_week, direccionamiento, jorge_wolf, lega, otros_pedidos, calculo_pendientes, cierre_masivo,  cerrar_pedido, eliminar_bd, fechas, gestion_bd, index, limpiar_base, menu_pendientes, pedidos_week, vencidos
...
urlpatterns = [
    ...
    path('cerrar/<int:id_pedido>/<str:fecha_cierre>/<str:hora_cierre>', cerrar_pedido, name="cerrar"),
    ...
    path('jorge_wolf/', jorge_wolf, name="jorge"),
