...
from gestionvencimientos.views import busqueda_vencidos, calculo_next_week, logout, otros_pedidos, calculo_pendientes, cierre_masivo,  cerrar_pedido, eliminar_bd, fechas, gestion_bd, index, limpiar_base, menu_pendientes, pedidos_week, vencidos
