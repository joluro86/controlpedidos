...
class Ans(models.Model):    
    ...
    Fecha_Recibo = models.CharField(max_length=500, default=0, null=True)
    Fecha_Ingreso_Sol = models.CharField(max_length=500, default=0, null=True)
    Fecha_Concepto = models.CharField(max_length=500, default=0, null=True)
    Fecha_Inicio_ANS = models.CharField(max_length=500, default=0, null=True)
    Días_ANS = models.DecimalField(decimal_places=2, max_digits=100, default=0.00, null=True)
    ...
    Fecha_Programación = models.CharField(max_length=5000, default=0, null=True)
    ...
    dias_vencimiento = models.IntegerField(verbose_name="Dias de vencimiento", default=0, null=True)
    dias_vencimiento_epm = models.IntegerField(verbose_name="Dias de vencimiento epm", default=0, null=True)
    fecha_vencimiento = models.CharField(max_length=30, verbose_name="Fecha vencimiento", default=0, null=True)
    encargado = models.CharField(max_length=100, null=True)
    estado_cierre = models.IntegerField(default=0, null=True)
    fecha_cierre = models.CharField(max_length=100, null=True, default=0)
    fecha_vence_sin_hora= models.CharField(max_length=50, default=0, null=True)
    hora_vencimiento = models.CharField(max_length=50, default=0, null=True)
    fecha_vence_epm= models.CharField(max_length=50, default=0, null=True)
