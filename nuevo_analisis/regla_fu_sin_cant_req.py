...
def evaluar_pedidos_regla_factor_unico_sin_cantidad_requerida(regla, pedidos_a_evaluar):
    ...
    for pedido in pedidos_a_evaluar:
        ...
        crear_novedad_bandera = verificar_cumplimiento_regla_sin_cantidad_requerida(pedido.get('pedido'),campo_busqueda, regla.item_busqueda, regla.cantidad, regla.comparador, regla.tipo_item_busqueda)
...
def verificar_cumplimiento_regla_sin_cantidad_requerida(pedido,campo_busqueda,  item_busqueda, cantidad, comparador, tipo_item_busqueda):
