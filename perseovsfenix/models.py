...
class matperseo(models.Model):
    ...
    cantidad=models.DecimalField(verbose_name='Cantidad', decimal_places=2, default=0, max_digits=10)   
...
class NovedadPerseoVsFenix(models.Model):
    ...
    cantidad_fenix=models.DecimalField(verbose_name='Can Fenix', decimal_places=2, default=0, max_digits=10) 
    diferencia=models.DecimalField(verbose_name='Diferencia', decimal_places=2, default=0, max_digits=10)
